...
| [`heartbeat.schema.json`](heartbeat.schema.json) | Periodic sensor liveness report (ADR-0003) |

All schemas currently require `schema_version: "1.0"`. Treat a schema edit as

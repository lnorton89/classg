...
func TestErrorEnvelope(t *testing.T) {
	...
	tests := []struct {
		...
		{"bad until", "GET", "/api/v1/tracks?until=tomorrow", "", 400, "invalid_parameter", "until"},
		{"inverted window", "GET",
			"/api/v1/tracks?since=2026-08-10T14:00:00Z&until=2026-08-09T14:00:00Z", "",
			400, "invalid_parameter", "until"},
		{"unlabelled aircraft", "GET", "/api/v1/aircraft/SER-NOPE/label", "", 404, "not_found", ""},
		{"bad aircraft flag", "PUT", "/api/v1/aircraft/SER-T1/label",
			`{"label":"x","flag":"banned"}`, 400, "invalid_parameter", "flag"},
		{"unknown label field", "PUT", "/api/v1/aircraft/SER-T1/label",
			`{"label":"x","jam":true}`, 400, "invalid_parameter", ""},
